...
window.onload = function(){
    let app = new Vue({
        ...
        methods: {
            ...
            synchronous(type){
                if(window.confirm('确定要同步价格吗？')){
                    ...
                    axios.post(`/newpricesystem/api?method=sync-price`,productList)
                    .then((response) => {
            ...
            search(){
                ...
                axios.post(`/newpricesystem/api?method=search`,keys)
                .then((response) => {
                    //console.log(response.data)
            ...
            getDatas(page){
                axios.post(`/newpricesystem/api?method=get-data&page=${page}&limit=${this.pageSize}`)
                .then((response) => {
                    //console.log(response.data)
                    this.loading = false;
        ...
        created() {
            axios.post(`/newpricesystem/api?method=sync-data`)
            .then((response) => {
                //console.log(response.data)
                this.getDatas(1);
            })
